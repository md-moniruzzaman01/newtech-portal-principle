...
export default function DashboardSidebar() {
  ...
  return (
    <div className="bg-[#263238]">
      <div
        className={cx(
          "w-full  opacity-100 sticky top-[-10px] left-0 pointer-events-auto duration-150   h-auto z-[999] "
        )}
      >
        {/* <button
      ...
      >
        ...
        <div className="mt-[32px] md:mt-[200px] px-[25px] pb-8 md:pb-12">
          <Button
            ...
            className="w-full px-0 lg:px-5 py-[16px] md:py-3 lg:py-[16px] text-xl gap-2 !bg-red-600 btn-shadow"
